        ...
        <div id="navbar" class="navbar navbar-default ace-save-state">
            <div class="navbar-container ace-save-state" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <router-link :to="{path:'/welcome'}" class="navbar-brand">
                        <small>
                    ...
                    <li class="" @click="expand($event)">
                        ...
                        <ul class="submenu">
                            <li class="" id="business-category-sidebar">
                                <router-link :to="{path:'/business/category'}" class="dropdown-toggle">
                            ...
                            <li class="" id="business-section-sidebar">
                                <router-link :to="{path:'/business/section'}" class="dropdown-toggle">
                                    <i class="menu-icon fa fa-caret-right"></i>
    ...
    export default {
        ...
        methods: {
            setSideBarActive(sidebarId) {
                if (sidebarId) {
                    ...
                    $('#' + sidebarId)
                        .addClass('active')
                        .parent('ul').parent('li').addClass('active').addClass('open')
                }
            },
            expand(event) {
        ...
        watch: {
            $route(val, oldVal) {
                let _this = this;
                _this.$nextTick(() => {
                    _this.setSideBarActive(val.meta.sidebarId)
                })
            }
        },
        mounted() {
            ...
            _this.setSideBarActive(_this.$route.meta.sidebarId)
        }
    }
</script>
