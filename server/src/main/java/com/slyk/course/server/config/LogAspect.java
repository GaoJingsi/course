package com.slyk.course.server.config;
...
public class LogAspect {
    ...
    /** 定义一个切点 */
    @Pointcut("execution(public * com.slyk.course.*.controller..*Controller.*(..))")
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        // 打印业务操作
        String nameCn = "";
        if (name.toLowerCase().contains("list") || name.toLowerCase().contains("query")) {
            nameCn = "查询";
        } else if (name.toLowerCase().contains("save")) {
            nameCn = "保存";
